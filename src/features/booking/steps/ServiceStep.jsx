...
const sg = {
  ...
  thDate:    { textAlign: 'center', padding: '0 5px 4px', minWidth: '46px' },
  ...
  tdAll:     { paddingBottom: '4px', paddingRight: '4px' },
  ...
  tdChk:     { textAlign: 'center', paddingBottom: '4px' },
  chk:       { width: '15px', height: '15px', cursor: 'pointer', accentColor: COLORS.blue },
