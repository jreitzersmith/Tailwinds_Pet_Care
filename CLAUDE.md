...
| Phase | Scope | Status |
|---|---|---|
| 1 | Marketing site: Home/Hero, Services, About, Contact, Service Area map, social links | ✅ Complete |
| 2 | Auth + Booking: Supabase schema, customer login, booking flow, customer portal, distance pricing | ✅ Complete |
